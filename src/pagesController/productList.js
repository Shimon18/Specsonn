...
class productList extends Component {
        ...
        .then(res => {
            if(res.dataCount == 0){
                ...
                res.response.map((data,index) => {                    
                    //console.log(data.product_Name_Display+'-----'+index);
                    _listing.push(data);
                });               
                ...
                let _urlSorting = global.sortingListSync+'?category_Id='+_categoryId+'&country_Id='+global.country_Ids+'&language_Id='+global.language_Ids+'&typTxt='+_typTxt+'&catsTxt='+_catsTxt+'&master='+_filterArrys.master+filterParam;
    ...
    sortingArea(){
        ...
        {            
            ...
            typeData = <div key={1+1} className="card"><div className="card-header" id="headingOne"><h2 className="filterHeading mb-0">{_prlTxt.filterArea.frameType}</h2></div><div id="collapseOne"><div className="card-body"><ul className="iris_filter_1">{frShp}</ul></div></div></div>;
            }
            ...
            {                
                ...
                shapeData = <div key={1+2} className="card"><div className="card-header" id="headingOne"><h2 className="filterHeading mb-0">{_prlTxt.filterArea.frameShape}</h2></div><div id="collapseTwo" className="collapse show" ><div className="card-body"><ul className="iris_filter_1">{frShp}</ul></div></div></div>;
            }
            ...
            {                
                ...
                colorData = <div key={1+3} className="card"><div className="card-header" id="headingOne"><h2 className="irisoptical mb-0"><button type="button" className="btn btn-link" data-toggle="collapse" data-target="#collapseThree">{_prlTxt.filterArea.frameColor}<i className="fas fa-sort-down float-right"></i></button></h2></div><div id="collapseThree" className="collapse hide" aria-labelledby="headingOne" data-parent="#accordionExample"><div className="card-body"><ul className="iris_filter_1">{frShp}</ul></div></div></div>;
            }
            ...
            {                
                ...
                brandData = <div key={1+4} className="card"><div className="card-header" id="headingOne"><h2 className="irisoptical mb-0"><button type="button" className="btn btn-link" data-toggle="collapse" data-target="#collapseFour">{_prlTxt.filterArea.framebrand}<i className="fas fa-sort-down float-right"></i></button></h2></div><div id="collapseFour" className="collapse hide" aria-labelledby="headingOne" data-parent="#accordionExample"><div className="card-body"><ul className="iris_filter_1">{frShp}</ul></div></div></div>;
            }
            ...
            {                
                ...
                sizeData = <div key={1+5} className="card"><div className="card-header" id="headingOne"><h2 className="irisoptical mb-0"><button type="button" className="btn btn-link" data-toggle="collapse" data-target="#collapseFive">{_prlTxt.filterArea.frameSize}<i className="fas fa-sort-down float-right"></i></button></h2></div><div id="collapseFive" className="collapse hide" aria-labelledby="headingOne" data-parent="#accordionExample"><div className="card-body"><ul className="iris_filter_1">{frShp}</ul></div></div></div>;
            }
            ...
            {                
                ...
                genderData = <div key={1+6} className="card"><div className="card-header" id="headingOne"><h2 className="irisoptical mb-0"><button type="button" className="btn btn-link" data-toggle="collapse" data-target="#collapseSix">{_prlTxt.filterArea.frameGender}<i className="fas fa-sort-down float-right"></i></button></h2></div><div id="collapseSix" className="collapse hide" aria-labelledby="headingOne" data-parent="#accordionExample"><div className="card-body"><ul className="iris_filter_1">{frShp}</ul></div></div></div>;
            }
            ...
            {                
                ...
                materialData = <div key={1+7} className="card mb-LX"><div className="card-header" id="headingOne"><h2 className="irisoptical mb-0"><button type="button" className="btn btn-link" data-toggle="collapse" data-target="#collapseSeven">{_prlTxt.filterArea.frameMaterial}<i className="fas fa-sort-down float-right"></i></button></h2></div><div id="collapseSeven" className="collapse hide" aria-labelledby="headingOne" data-parent="#accordionExample"><div className="card-body"><ul className="iris_filter_1">{frShp}</ul></div></div></div>;
            }
    ...
    showMore(){
     ...
     showFilter = () => {
        ...
        if (
            ...
            document.getElementById("filter_button").style.background = "#eb4057";
            document.getElementById("filter_button").style.color = "white";
        ...
        closeFilter = () => {
            ...
            if (
                ...
                document.getElementById("filter_button").style.background = "white";
                document.getElementById("filter_button").style.color = "black";
                ...
                <div className="iris_prolist">                    
                    ...
                    <section className="iris_product_listing" id={_hiddenIsFull}>
                        <div className="row">
                            ...
                            <div className="col-lg-4 iris_PL_sidebar for_desktop">
                            ...
                            <div  className="for_mobile ">
                                <div className="Filter_button_div">
                                    <button> <select className="iris_sort iris_sorts" onChange={this.handleSortboxChange.bind(this)}>
                                    ...
                                    <button id="filter_button" onClick={ () => {this.showFilter()} }>Filter:</button>
                                </div>
                            <div className="bs-example" id="mobilefilter">
                                <button className="close_filterbtn" onClick={ () => {this.closeFilter()} }><i className="fa  fa-times"></i></button>
                                    <div className="accordion" id="accordionExample">
                                        {this.sortingArea()}                                        
                                    </div>
                                </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-4">
                                            <ul>
                                                ...
                                                <li><a href={global.BASE_URL}> {this.Capitalize(_catsTxt.replace(/-/g, " "))} </a><span className="breadSpce">&gt; </span></li>
                                        ...
                                        <div className="col-lg-3 for_desktop">
