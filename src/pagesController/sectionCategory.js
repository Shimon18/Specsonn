...
class sectionCategory extends Component {
    ...
    renderView(handle,filterParam,know){
        _catsTxt = handle.cagTxt;
        _filterId = handle.sectionTxt;
        ...
        let _urlData = global.categorySectionListSync+'?country_Id='+global.country_Ids+'&language_Id='+global.language_Ids+'&filterId='+_filterId+filterParam+'&limit='+_limit+',6';
        ...
        .then(res => {
            ...
            if(res.dataCount == 0){
                ...
                //let _urlSorting = global.sortingListSync+'?country_Id='+global.country_Ids+'&language_Id='+global.language_Ids+'&typTxt='+_typTxt+'&catsTxt='+_catsTxt+'&master='+_filterArrys.master+'&group='+_filterArrys.group;
                                                ...
                                                <span>
                                                    {
                                                        this.state.filterHeader.map((item,index) => {
                                                            ...
                                                            return(
                                                            <li key={item.id}><b>{_filtKy}</b>{item.name}<button onClick={() => this.removeFilterHeader(item)}>x</button></li>
                                                            )
                                                        })                                                    
                                                    }
                                                </span>
