...
export default class IrisCheckoutCart extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            irisCartItems:[],
    ...
    render(){ 
        ...
        if(this.state.isLoaded === true && this.state.cartCount > 0){     
            ...
            irisShow = this.state.irisCartItems.items.map((products,index) => {
                ...
                let _powerEye = '';
                if(products.power_option == 'Right' || products.power_option == 'Left'){
                    _powerEye = '( '+products.power_option+' Eye Contact Lens )';
                }
                ...
                return(
                    <div key={index} className="iris_cart_chekout_1">
                        ...
                        <div className="iris_cart_chekout_1B">
                            <h6 className="iris_cc_ttl">{products.product_Name} <small className="text-danger"><b>{_powerEye}</b></small></h6>
                            <div className="input-group iris_cart_grp">
                                ...
                                <input type="text" id={"quantity_"+index} name="quantity" className="form-control input-number" value={products.count} min="1" max="100" readOnly={true}/>
                                <span className="input-group-btn">
                            ...
                            <button className="iris_item_delte checkout_deletebtn" onClick={this.removeItemsCart.bind(this, index)}><i className="far fa-trash-alt"></i></button>

                            <table width="100%" cellPadding="0" cellSpacing="0" border="0">
                                <tbody>
                                    <tr>
                                        <td width="100%" className="d-flex justify-content-between total_price_div">
                        ...
                        <table width="100%" cellPadding="0" cellSpacing="0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="35%">
                                    <p>{global.currencyCode} <span>{parseFloat(cartTotal) - parseFloat(_RD)}</span></p>
                                    </td>
                                </tr>
