...
(function ($, global) {
    ...
    $.extend(sergelandimagezoomer, {
        ...
        dsetting: { //default settings
            ...
            loadopacity: 1, // прозрачность фона перекрытия tmb картинки при загрузке	big изображения
            loadbackground: '#FFFFFF', // цвет фона перекрытия tmb картинки при загрузке	 big изображения
            ...
            cursorshadeopacity: 1, // прозрачность контейнера лупы
            cursorshadeborder: '1px solid black', // внешний бордюра контейнера лупы в формате CSS
            zindex: '999999999', // z-index контейнера лупы 
            stepzoom: 1, // шаг зуммирования при прокрутке колеса мыши					
            zoomrange: [3, 3], // диапазон зуммирования+
			background: '#FFFFFF',
			opacity:0.5,
            zoomstart: 3, // стартовая установка зуммирования
            ...
            leftoffset: 115, // отступ слева от tmb картинки
